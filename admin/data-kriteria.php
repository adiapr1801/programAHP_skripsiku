            ...
            <?php $no=1; while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) :  ?>
              <tr>
                ...
                <td style="text-align:center;vertical-align:middle;">
                  ...
                  <a href="data-kriteria-hapus.php?id=<?php echo $row['id_kriteria'] ?>" onclick="return confirm('Yakin ingin menghapus data')" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>                </td>
              </tr>
            <?php endwhile; ?>
          </tbody>
        </table>
