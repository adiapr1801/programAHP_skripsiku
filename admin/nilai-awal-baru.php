	  ...
	  <div class="col-xs-12 col-sm-12 col-md-12">
	  	...
	  	<div class="panel panel-default">
                ...
                <div class="form-group">
                    <label for="id_alternatif">Pilih nama operator </label>
                    <select class="form-control" id="id_alternatif" name="id_alternatif" style="width:300px; border:1px solid #CCCCCC;">
                        <option value="">---</option>
